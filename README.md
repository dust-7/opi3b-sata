...
2. [Install patched linux-u-boot and linux-dtb debs](#install-patched-linux-u-boot-and-linux-dtb-debs)
3. [Build patched image using Github Actions](#build-patched-image-using-github-actions)
4. [Apply patches yourself](#apply-patches-yourself)
...
See [userpatches](https://github.com/dust-7/opi3b-sata/tree/main/userpatches) folder.
